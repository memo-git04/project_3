                        ...
                        <div class="card-body">
                            ...
                            <div id="activity">
                                <div class="media border-bottom-1 pt-3 pb-3">
                                    <img width="35" src="{{ asset('admin/images/avatar/1.jpg') }}" class="mr-3 rounded-circle" alt="">
                                ...
                                <div class="media border-bottom-1 pt-3 pb-3">
                                    <img width="35" src="{{ asset('admin/images/avatar/2.jpg') }}" class="mr-3 rounded-circle" alt="">
                                    <div class="media-body">
                                ...
                                <div class="media pt-3 pb-3">
                                    <img width="35" src="{{ asset('admin/images/avatar/3.jpg') }}" class="mr-3 rounded-circle" alt="">
                                    <div class="media-body">
