...
<html class="no-js" lang="en">
  <head>
    ...
    <!-- CSS
    ========================= -->
    <link rel="stylesheet" href="{{asset('store/css/vendor/bootstrap.min.css')}}" />
    <link rel="stylesheet" href="{{asset('store/css/slick.css')}}" />
    <link rel="stylesheet" href="{{asset('store/css/simple-line-icons.css')}}" />
    <link rel="stylesheet" href="{{asset('store/css/ionicons.min.css')}}" />
    <link rel="stylesheet" href="{{asset('store/css/font.awesome.css')}}" />
    <link rel="stylesheet" href="{{asset('store/css/animate.css')}}" />
    <link rel="stylesheet" href="{{asset('store/css/nice-select.css')}}" />
    <link rel="stylesheet" href="{{asset('store/css/jquery-ui.min.css')}}" />
          ...
          <div class="col-12">
            <div class="offcanvas_menu_wrapper">
              ...
              <div class="header_contact_info">
                <ul class="d-flex">
                  <li class="text-white">
                    ...
                    <a href="tel:+05483716566">+84 983683244</a>
                  </li>
                  <li class="text-white">
              ...
              <div class="header_social d-flex">
                ...
                <ul class="d-flex">
                  <li>
                    <a href="#"><i class="icon-social-twitter icons"></i></a>
                  </li>
                  <li>
                    <a href="#"><i class="icon-social-facebook icons"></i></a>
                  </li>
                  <li>
                    <a href="#"><i class="icon-social-instagram icons"></i></a>
                  </li>
                  <li>
                    <a href="#"><i class="icon-social-youtube icons"></i></a>
                  </li>
                  <li>
                    <a href="#"><i class="icon-social-pinterest icons"></i></a>
                  </li>
                </ul>
              </div>
              <div class="language_currency">
                <ul class="d-flex">
                  <li class="language">
                    <a href="#">
                      Eng <i class="icon-right ion-ios-arrow-down"></i
                    ></a>
                  ...
                  <li class="currency">
                    <a href="#">
                      USd <i class="icon-right ion-ios-arrow-down"></i
                    ></a>
              ...
              >
                ...
                <div class="header_logo">
                  <a class="sticky_none" href="{{route('home')}}"
                    ><img src="{{asset('store/img/logo/logo.png')}}" alt=""
                  /></a>
                </div>
                <!--main menu start-->
                  ...
                  <nav>
                    <ul class="d-flex">
                      ...
                      <li>
                        <a href="#">pages</a>
                        <ul class="sub_menu">
                          <li><a href="{{route('cart')}}">Cart Pages</a></li>
    ...
    <section class="newsletter_section">
      <div class="container">
        <div class="row">
          <div class="col-12">
            <div
              class="newsletter_inner d-flex justify-content-between align-items-center"
            >
...
============================================ -->
    ...
    <script src="{{asset('store/js/vendor/jquery-3.4.1.min.js')}}"></script>
    <script src="{{asset('store/js/vendor/popper.js')}}"></script>
    <script src="{{asset('store/js/vendor/bootstrap.min.js')}}"></script>
    <script src="{{asset('store/js/slick.min.js')}}"></script>
    <script src="{{asset('store/js/wow.min.js')}}"></script>
    <script src="{{asset('store/js/jquery.scrollup.min.js')}}"></script>
    <script src="{{asset('store/js/images-loaded.min.js')}}"></script>
    <script src="{{asset('store/js/isotope.pkgd.min.js')}}"></script>
    <script src="{{asset('store/js/jquery.nice-select.js')}}"></script>
    <script src="{{asset('store/js/tippy-bundle.umd.js')}}"></script>
    <script src="{{asset('store/js/jquery-ui.min.js')}}"></script>
    <script src="{{asset('store/js/jquery.instagramFeed.min.js')}}"></script>
    <script src="{{asset('store/js/jquery.magnific-popup.min.js')}}"></script>
    <script src="{{asset('store/js/mailchimp-ajax.js')}}"></script>
