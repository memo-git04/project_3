            ...
            <div class="product_container row">
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="all" role="tabpanel">
                        <div
                            class="product_slick slick_slider_activation"
                            data-slick='{
                            "slidesToShow": 4,
                            "slidesToScroll": 1,
                            "arrows": true,
                            ...
                            <article class="col single_product">
                                <figure>
                                    ...
                                    <figcaption class="product_content text-center">
                                        ...
                                        <div class="add_to_cart">
                                            <a title="Add To Cart" class="btn btn-primary" href="#"
                                            >Add To Cart</a
                                            >
                                        </div>
                                    </figcaption>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <figure class="single_banner position-relative">
                        <img src="{{asset('store/img/bg/bg3.jpg')}}" alt="" />
                                ...
                                <figure>
                                    <div class="product_thumb">
                                        <a href="">
                                            <img
                                                class="primary_img"
                                                src="{{asset('store/img/product/product3.jpg')}}"
                                                alt="consectetur"
                                            />
                                        </a>
                                        <div class="product_action">
